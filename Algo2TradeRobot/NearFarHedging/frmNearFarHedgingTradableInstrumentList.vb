Public Class frmNearFarHedgingTradableInstrumentList

    Private _TradableInstruments As IEnumerable(Of NearFarHedgingStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of NearFarHedgingStrategyInstrument))
        InitializeComponent()
        Me._TradableInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmNearFarHedgingTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
