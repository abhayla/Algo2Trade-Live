Public Class frmPetDGandhiTradableInstrumentList

    Private _TradableInstruments As IEnumerable(Of PetDGandhiStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of PetDGandhiStrategyInstrument))
        InitializeComponent()
        Me._TradableInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmPetDGandhiTradableInsruments_Load(sender As Object, e As EventArgs) Handles MyBase.Load
