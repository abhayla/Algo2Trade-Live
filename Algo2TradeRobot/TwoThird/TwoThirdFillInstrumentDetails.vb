...
#End Region
    ...
    Private ReadOnly _userInputs As TwoThirdUserInputs
                            ...
                            If _userInputs.InstrumentDetailsFilePath IsNot Nothing AndAlso
                                ...
                                Using csv As New CSVHelper(_userInputs.InstrumentDetailsFilePath, ",", _cts)
                                    ...
                                    For Each stock In todayStockList
                                        ...
                                        End If
                                    Next
                                    If _userInputs.ManualInstrumentList IsNot Nothing AndAlso
                                        _userInputs.ManualInstrumentList <> "" Then
                                        Dim manualStockData As String() = _userInputs.ManualInstrumentList.Trim.Split(vbNewLine)
