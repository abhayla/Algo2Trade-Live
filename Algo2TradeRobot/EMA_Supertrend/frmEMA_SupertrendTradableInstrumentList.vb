Public Class frmEMA_SupertrendTradableInstrumentList

    Private _TradableInstruments As IEnumerable(Of EMA_SupertrendStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of EMA_SupertrendStrategyInstrument))
        InitializeComponent()
        Me._TradableInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmEMA5_20STTradableInstrumentList_Load(sender As Object, e As EventArgs) Handles MyBase.Load
