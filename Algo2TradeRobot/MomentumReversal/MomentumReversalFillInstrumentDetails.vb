...
Public Class MomentumReversalFillInstrumentDetails
...
#End Region
    ...
    Private ReadOnly _parentStrategy As MomentumReversalStrategy
    Private ReadOnly _userInputs As MomentumReversalUserInputs
    ...
    Public Sub New(ByVal canceller As CancellationTokenSource, ByVal parentStrategy As MomentumReversalStrategy)
        _cts = canceller
                        ...
                        Dim stocksLessThanMaxBlankCandlePercentage As IEnumerable(Of KeyValuePair(Of String, InstrumentDetails)) =
                                    capableStocks.Where(Function(x)
                                                            Return x.Value.BlankCandlePercentage <> Decimal.MinValue AndAlso
                                                                  x.Value.BlankCandlePercentage <= _userInputs.BlankCandlePercentage
                                                        End Function)
