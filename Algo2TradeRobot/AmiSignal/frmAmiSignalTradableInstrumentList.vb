Public Class frmAmiSignalTradableInstrumentList

    Private _TradableInstruments As IEnumerable(Of AmiSignalStrategyInstrument)
    Public Sub New(ByVal associatedTradableInstruments As IEnumerable(Of AmiSignalStrategyInstrument))
        InitializeComponent()
        Me._TradableInstruments = associatedTradableInstruments
    End Sub

    Private Sub frmAmiSignalTradableInstruments_Load(sender As Object, e As EventArgs) Handles MyBase.Load
